...
*/
export default function Cypher({ usersTitle, lastMessageDate, lastMessageText }) {
  ...
  const loadCypher = () => {
    ...
    return (
        <>
                <div className="bg-slate-900 hover:bg-slate-800 rounded-b px-4 pt-5 pb-4 sm:p-6 sm:pb-4" onClick={loadCypher}>
                    <div className="flex items-start">
                        ...
                        <div className="mt-3 w-full text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <div className="flex justify-between">
                                <h3 className="text-lg leading-6 font-medium text-gray-500">{usersTitle}</h3>
                                <p className="text-sm font-bold text-gray-500">{lastMessageDate}</p>
                            </div>
